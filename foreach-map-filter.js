...
value and returns the array passed to the function with the new key and value added 
for each object 
...
function addKeyAndValue(arr,key,value){
    ...
    arr.forEach(function(val){ //had to look at solution
        val[key] = value;
    })
    return arr;
}
...
Examples:
    extractFullName([
        ...
        last:"Lane"}, 
        {first: 'Colt', 
        last:"Steele"}]) // ['Elie Schoppik', 'Tim Garcia', 'Matt Lane', 'Colt Steele']
*/
